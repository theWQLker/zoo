...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add_service'])) {
        $category_id = $_POST['category_id']; // You can remove this line if you are not using category_id in the form
        $name = $_POST['name'];
...
// Fetch Services without Category (You can remove the JOIN if no category is needed)
