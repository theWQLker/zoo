...
<body>
        ...
        <tr>
            ...
            <td>
                <form method="post" style="display:inline;">
                    ...
                    <input type="hidden" name="category_id" value="<?php echo htmlspecialchars($service['category_id']); ?>">
                    ...
                    <button type="submit" name="edit_service_form">Edit</button>
    ...
    <form method="post">
        ...
        <button type="submit" name="<?php echo isset($_POST['edit_service_form']) ? 'edit_service' : 'add_service'; ?>">
